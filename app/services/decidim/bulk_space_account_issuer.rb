...
module Decidim
  ...
  class BulkSpaceAccountIssuer
    ...
    PASSWORD_LENGTH = 10
    # 大文字英字と数字のみ（紙面配布・読み上げ・手入力を想定）。記号は JIS/US 配列差・全角混入・
    # \ と ¥ の表示揺れを招くため使わない。区切り文字（ハイフン・スペース）も入れずベタ書きにする。
    # 誤読の温床になる 0/O・1/I/L・U/V の組から 0 O 1 I L U を、読み上げで 9（キュウ）と
    # 紛れる Q（キュー）を除いた29文字。10桁で約48.6bit（29^10 ≈ 4.2×10^14）。
    PASSWORD_CHARSET = "23456789ABCDEFGHJKMNPRSTVWXYZ".chars.freeze

    # 各文字のカタカナ読み。数字は通常読み。配布物の「フリガナ」列に使う。
    FURIGANA = {
      "A" => "エー", "B" => "ビー", "C" => "シー", "D" => "ディー", "E" => "イー",
      "F" => "エフ", "G" => "ジー", "H" => "エイチ", "J" => "ジェー", "K" => "ケー",
      "M" => "エム", "N" => "エヌ", "P" => "ピー", "R" => "アール",
      "S" => "エス", "T" => "ティー", "V" => "ブイ", "W" => "ダブリュー",
      "X" => "エックス", "Y" => "ワイ", "Z" => "ゼット",

...
namespace :delete do
  ...
  task destroy_all_comments: :environment do
    puts "Start destroy_all_comments of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_comments of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all accountability for a given organization"
  task destroy_all_accountability: :environment do
    puts "Start destroy_all_accountability of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_accountability of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all attachments for a given organization"
  task destroy_all_attachments: :environment do
    puts "Start destroy_all_attachments of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_attachments of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all budgets for a given organization"
  task destroy_all_budgets: :environment do
    puts "Start destroy_all_budgets of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_budgets of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all proposals for a given organization"
  task destroy_all_proposals: :environment do
    puts "Start destroy_all_proposals of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_proposals of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all blogs for a given organization"
  task destroy_all_blogs: :environment do
    puts "Start destroy_all_blogs of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_blogs of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all debates for a given organization"
  task destroy_all_debates: :environment do
    puts "Start destroy_all_debates of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_debates of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all meetings for a given organization"
  task destroy_all_meetings: :environment do
    puts "Start destroy_all_meetings of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_meetings of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all pages for a given organization"
  task destroy_all_pages: :environment do
    puts "Start destroy_all_pages of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_pages of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all surveys for a given organization"
  task destroy_all_surveys: :environment do
    puts "Start destroy_all_surveys of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_surveys of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all assemblies for a given organization"
  task destroy_all_assemblies: :environment do
    puts "Start destroy_all_assemblies of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_assemblies of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all participatory_processes for a given organization"
  task destroy_all_participatory_processes: :environment do
    puts "Start destroy_all_participatory_processes of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_participatory_processes of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all areas for a given organization"
  task destroy_all_areas: :environment do
    puts "Start destroy_all_areas of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_areas of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy all newsletters for a given organization"
  task destroy_all_newsletters: :environment do
    puts "Start destroy_all_newsletters of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  ...
  task destroy_all_users: :environment do
    puts "Start destroy_all_users of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_all_users of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end

  desc "Destroy a given organization"
  task destroy_organization: :environment do
    puts "Start destroy_organization of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
    ...
    puts "Finish destroy_organization of #{ENV.fetch("DECIDIM_ORGANIZATION_NAME")}"
  end
